...
const blog_id = Joi.object({
    blog_hex_id: Joi.string().hex().length(24).required()
})

const blog_id_and_article_index = Joi.object({
    blog_hex_id: Joi.string().hex().length(24).required(),
    article_index: Joi.number().integer().required()
})

//one_blog_id_with_article_index
const blog_id_optional_article_index = Joi.object({
    blog_hex_id: Joi.string().hex().length(24).required(),
...
module.exports = {
    ...
    pagination,
    blog_id,
    blog_id_and_article_index,
    blog_id_optional_article_index,
    blog_meta,
