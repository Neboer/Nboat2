...
router.delete('/:blog_hex_id', validator.params(schema.blog_id), (req, res, next) => {
...
router.delete('/:blog_hex_id/:article_index', validator.params(schema.blog_id_and_article_index),
    (req, res, next) => {
